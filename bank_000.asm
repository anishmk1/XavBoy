...
; Display credits screen
    call Call_000_27d7
    ld de, $4a07                ; ANISH - $036f reaching here
    call Call_000_27eb
    call Call_000_178a
    ld hl, $c300
    ld de, $6450
...
jr_000_037e:
    ...
    ld a, $d3                   ; ANISH - $0386     -- ENabling LCD for credit screen
    ldh [rLCDC], a
...
; Wait for initial credit screen timer to run out.
    ldh a, [$FFa6]              ; ANISH - $0393 -- from RST_30 jp hl
    and a
    ret nz
...
Call_000_27ad:
    ...
    ld de, $8300
    ld bc, $0d00
    call Call_000_27a4      ;; ANISH - @ $27e0 - raeches here
    ret
